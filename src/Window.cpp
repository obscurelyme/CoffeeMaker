...
int BasicWindow::DisplayCount() const
{
...
ScreenDPI BasicWindow::GetScreenDPI() const
{
  return _screenDpi;
}
...
SDL_Window *BasicWindow::Handle() const
{
  return _window;
}

void BasicWindow::ShowWindow() const {
