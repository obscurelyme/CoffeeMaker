...
Logger::Logger()
{
  ...
  _consoleSink->set_level(spdlog::level::warn);
...
{
  _logger->_spdlog->trace(msg);
}

void Logger::Debug(std::string msg)
{
  _logger->_spdlog->debug(msg);
}
void Logger::Warn(std::string msg)
{
  _logger->_spdlog->warn(msg);
}
void Logger::Info(std::string msg)
{
  _logger->_spdlog->info(msg);
}
void Logger::Error(std::string msg)
{
  _logger->_spdlog->error(msg);
}
void Logger::Critical(std::string msg)
{
  _logger->_spdlog->critical(msg);
}
